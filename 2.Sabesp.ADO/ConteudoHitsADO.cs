...
{
	public class ConteudoHitsADO : ADOSuper, IConteudoHitsDAL {
		...
		public ConteudoHits Carregar(int conteudoId) {		
			ConteudoHits entidade = new ConteudoHits();
		...
		public List<ConteudoHits> CarregarTodos(int registrosPagina, int numeroPagina, string[] ordemColunas, string[] ordemSentidos, IFilterHelper filtro) {
        ...
        /// </summary>
		public List<ConteudoHits> CarregarTodos() {			
