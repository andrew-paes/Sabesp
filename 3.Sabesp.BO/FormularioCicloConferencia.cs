...
{	
	...
	[Serializable]
	public class FormularioCicloConferencia 
	{
		// Construtor
		public FormularioCicloConferencia() {}

		// Construtor com identificador
		public FormularioCicloConferencia(int formularioCicloConferenciaId) {
			_formularioCicloConferenciaId = formularioCicloConferenciaId;
		}

		private int _formularioCicloConferenciaId;
		...
		public int FormularioCicloConferenciaId {
			get { return _formularioCicloConferenciaId; }
        ...
        public bool Valido
        {
            get { return Validation.Validate<FormularioCicloConferencia>(this).IsValid; }
        }
        ...
        {
            return Validation.Validate<FormularioCicloConferencia>(this);
        }
	}
	
	public struct FormularioCicloConferenciaColunas
	{	
		public static string FormularioCicloConferenciaId = @"formularioCicloConferenciaId";
