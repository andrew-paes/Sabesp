...
{
	public class FormularioApoioInstitucionalFH : IFilterHelper
	{
		private string _formularioApoioInstitucionalId;
		public string FormularioApoioInstitucionalId
		{
			get { return _formularioApoioInstitucionalId == null ? String.Empty : _formularioApoioInstitucionalId; }
		...
		{
			get { return _duvida == null ? String.Empty : _duvida; }
			set { _duvida = value; }
		}
		...
		public string GetWhereString()
		{
			...
			if (!FormularioApoioInstitucionalId.Equals(String.Empty))
			{
				sbWhere.Append(" AND (formularioApoioInstitucionalId=" + FormularioApoioInstitucionalId + ")");
			}
			...
			if (!Duvida.Equals(String.Empty))
			{
				sbWhere.Append(" AND (duvida LIKE '%" + Duvida + "%')");
			}
