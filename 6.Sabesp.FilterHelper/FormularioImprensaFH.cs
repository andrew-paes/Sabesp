...
{
	public class FormularioImprensaFH : IFilterHelper
	{
		private string _formularioImprensaId;
		public string FormularioImprensaId {
			get { return _formularioImprensaId==null?String.Empty:_formularioImprensaId; }
		...
		{			
			...
			if (!FormularioImprensaId.Equals(String.Empty)) {
				sbWhere.Append(" AND (formularioImprensaId="+FormularioImprensaId+")");
			}
