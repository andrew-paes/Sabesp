...
{
	public class FormularioSegurancaTrabalhoFH : IFilterHelper
	{
		private string _formularioSegurancaTrabalhoId;
		public string FormularioSegurancaTrabalhoId
		{
			get { return _formularioSegurancaTrabalhoId == null ? String.Empty : _formularioSegurancaTrabalhoId; }
		...
		public string GetWhereString()
		{
			...
			if (!FormularioSegurancaTrabalhoId.Equals(String.Empty))
			{
				sbWhere.Append(" AND (formularioSegurancaTrabalhoId=" + FormularioSegurancaTrabalhoId + ")");
			}
