<%@ Control Language="C#" AutoEventWireup="true" CodeFile="arquivonoticia.ascx.cs"
	Inherits="content_module_arquivonoticia_arquivonoticia" %>
...
<br />
<ag2:UploadField runat="server" ID="uplField" TargetFolder="noticia/galeria/" MaxFileLength="50000" />
<br />
<br />
