...
<br />
<ag2:HtmlTextBox ID="txtResumo" runat="server" />
<br />
<br />
...
<strong>Local: </strong>
<br />
<asp:TextBox ID="txtLocal" runat="server" Width="450px" />
<br />
<br />
...
<br />
<asp:CheckBoxList ID="chbCategoria" runat="server" RepeatDirection="Horizontal" RepeatColumns="3"
	OnDataBound="chbCategoria_DataBound">
</asp:CheckBoxList>
<br />
<br />
...
<ag2:SubForm runat="server" ID="sfArquivo" SqlStringCommand="Select * From arquivo Where arquivoId = @arquivoId"
	DataValueField="arquivoId" DataTextField="nomeArquivo" ModuloSubForm="arquivoEvento"
