...
public partial class content_module_tituloImagemLinkTexto_tituloImagemLinkTexto : SmartUserControl
{
	#region [ Properties ]
	...
	private void AddRow(ControleIdiomaDado entidadeParam)
	{
		...
		drow["Arquivo"] = entidadeParam.ImagemNome;
	...
	private void FormToLoad()
	{
		...
		if (IdRegistro > 0)
		{
			...
			for (int i = 0; i < this.DT.Rows.Count; i++)
			{
				...
				{
					entidadeControleIdiomaDado.ImagemNome = this.DT.Rows[i]["Arquivo"].ToString();
				}
