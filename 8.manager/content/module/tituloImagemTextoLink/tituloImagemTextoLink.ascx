<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tituloImagemTextoLink.ascx.cs"
	Inherits="content_module_tituloImagemTextoLink_tituloImagemTextoLink" %>
<br />
...
<fieldset style="width: 600px;">
	...
	<br />
	<ag2:UploadField runat="server" ID="uplField" TargetFolder="box/" MaxFileLength="50000" />
	<br />
	...
	<asp:GridView ID="gdvTituloTextoLink" runat="server" AutoGenerateColumns="False"
		DataKeyNames="idGridView,Texto,Link,Arquivo,Janela" BackColor="White" BorderColor="#DEDFDE"
		...
		<Columns>
			...
			<asp:BoundField HeaderText="Texto" DataField="Texto" ControlStyle-Width="200px">
				<ControlStyle Width="200px"></ControlStyle>
				<HeaderStyle Width="200px" />
			</asp:BoundField>
			<asp:BoundField HeaderText="Link" DataField="Link" ControlStyle-Width="150px">
				<ControlStyle Width="150px"></ControlStyle>
				<HeaderStyle Width="150px" />
			</asp:BoundField>
			<asp:BoundField HeaderText="Imagem" DataField="Arquivo" ControlStyle-Width="100px">
