<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tituloSubtituloTextoLink.ascx.cs"
...
<fieldset style="width: 600px;">
	...
	<br />
	<asp:TextBox ID="txtSubtitulo" runat="server" Width="595px" MaxLength="200"></asp:TextBox>
	<br />
	...
	<asp:GridView ID="gdvTituloTextoLink" runat="server" AutoGenerateColumns="False"
		DataKeyNames="idGridView,Subtitulo,Texto,Link,Janela" BackColor="White" BorderColor="#DEDFDE"
		...
		<Columns>
			...
			<asp:BoundField HeaderText="Subtitulo" DataField="Subtitulo" ControlStyle-Width="175px">
				<ControlStyle Width="175px"></ControlStyle>
				<HeaderStyle Width="175px" />
			</asp:BoundField>
			<asp:BoundField HeaderText="Texto" DataField="Texto" ControlStyle-Width="175px">
				<ControlStyle Width="175px"></ControlStyle>
				<HeaderStyle Width="175px" />
			</asp:BoundField>
			<asp:BoundField HeaderText="Link" DataField="Link" ControlStyle-Width="100px">
