<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tituloTextoArquivo.ascx.cs"
	Inherits="content_module_tituloTextoArquivo_tituloTextoArquivo" %>
<br />
...
<fieldset style="width: 600px;">
	...
	<asp:GridView ID="gdvTituloTextoLink" runat="server" AutoGenerateColumns="False"
		DataKeyNames="idGridView,Texto,Arquivo" BackColor="White" BorderColor="#DEDFDE"
		...
		<Columns>
			...
			<asp:BoundField HeaderText="Texto" DataField="Texto" ControlStyle-Width="350px">
				<ControlStyle Width="350px"></ControlStyle>
				<HeaderStyle Width="350px" />
			</asp:BoundField>
			<asp:BoundField HeaderText="Arquivo" DataField="Arquivo" ControlStyle-Width="150px">
