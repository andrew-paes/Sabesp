<%@ Control Language="C#" AutoEventWireup="true" CodeFile="tituloTextoCaixaEsquerda.ascx.cs"
	Inherits="content_module_tituloTextoCaixaEsquerda_tituloTextoCaixaEsquerda" %>
<br />
