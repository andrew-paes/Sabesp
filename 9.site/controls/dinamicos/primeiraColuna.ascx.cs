...
public partial class controls_dinamicos_primeiraColuna : SmartUserControl
{
	#region Events
	...
	protected void GetControls()
	{
		...
		List<ControleSessao> listaControleSessao = (List<ControleSessao>)controleSessaoService.RetornaTodosSite(0, orderColumn, orderDirection, new ControleSessaoFH() { SecaoId = SecaoId.ToString(), Coluna = "1" });
