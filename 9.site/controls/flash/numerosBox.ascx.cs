...
public partial class CtlNumerosBox : SmartUserControl, IDinamicControl
{
	#region Properties
	...
	public CtlNumerosBox() { }

	public CtlNumerosBox(int controleId)
	{
	...
	protected void Page_Load(object sender, EventArgs e)
	{
		...
		urlFlash = ResolveUrl(String.Concat("~/contents/swf/numerosBox.swf?tempo=", tempoFlash));
	}
