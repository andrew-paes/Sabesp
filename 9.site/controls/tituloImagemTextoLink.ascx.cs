...
public partial class CtlTituloImagemTextoLink : SmartUserControl, IDinamicControl
{
	#region Properties
	...
	public CtlTituloImagemTextoLink() { }

	public CtlTituloImagemTextoLink(int controleId)
	{
