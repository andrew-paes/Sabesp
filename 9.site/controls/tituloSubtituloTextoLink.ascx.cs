...
public partial class CtlTituloSubtituloTextoLink : SmartUserControl, IDinamicControl
{
	#region Properties
	...
	public CtlTituloSubtituloTextoLink() { }

	public CtlTituloSubtituloTextoLink(int controleId)
	{
	...
	void rptConcurso_ItemDataBound(object sender, RepeaterItemEventArgs e)
	{
		...
		if (controleIdiomaDadoBOTemp != null)
		{
			...
			{
				ltlTexto.Text = String.Concat("<span>" + controleIdiomaDadoBOTemp.Subtitulo + "</span>"
											, "<a href=\"" + controleIdiomaDadoBOTemp.Link + "\" target=\"" + controleIdiomaDadoBOTemp.Target + "\" >"
