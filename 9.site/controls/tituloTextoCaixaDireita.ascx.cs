...
public partial class CtlTituloTextoCaixaDireita : SmartUserControl, IDinamicControl
{
	#region Properties
	...
	public CtlTituloTextoCaixaDireita() { }

	public CtlTituloTextoCaixaDireita(int controleId)
	{
