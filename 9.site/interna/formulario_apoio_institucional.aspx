<%@ Page Language="C#" MasterPageFile="~/masterpages/MasterPage.master" AutoEventWireup="true"
	CodeFile="formulario_apoio_institucional.aspx.cs" Inherits="interna_formulario_apoio_institucional" %>
		...
		<div class="colContent fullWidth interna">
			...
			<div class="colContentLeft">
				<div class="boxFormularios">
					<fieldset>
						<legend>Apoio Institucional</legend>
						...
						<div class="boxCampo">
							<asp:Label ID="lblDuvida" AssociatedControlID="txtDuvida" runat="server" Text="Dúvida"></asp:Label>
							<textarea validationgroup="form" id="txtDuvida" cols="45" rows="5" runat="server"></textarea>
							<asp:RequiredFieldValidator ValidationGroup="form" ControlToValidate="txtDuvida"
								Display="Dynamic" CssClass="errorMessage" ID="reqDuvida" runat="server"><div>Informe a dúvida</div></asp:RequiredFieldValidator>
						</div>
						<div class="clr">
							<!-- -->
						</div>
						<div class="boxCampo boxFull">
							<%--<asp:CheckBoxList RepeatLayout="Flow" ID="chkInformacoes" CssClass="lstChk" runat="server">
